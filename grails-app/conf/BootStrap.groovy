...
class BootStrap {
    ...
    def createFormTemplates(){
        ...
        if(ConsentFormTemplate.count()==0)
        {
            ...
            ).addToQuestions(new Question(optional: true, name: 'I agree to be contacted about ethically approved research studies for which I may be suitable. I understand that agreeing to be contacted does not oblige me to participate in any further studies.')
        ...
        if(ConsentFormTemplate.count()==1)
        {
            ...
            ).addToQuestions(new Question(optional: true, name: 'Clinically relevant results: I agree that findings from genetic and other testing related to the reason I am currently undergoing investigations will be fed back to my clinician so that they may be used in decisions about my treatment.')
