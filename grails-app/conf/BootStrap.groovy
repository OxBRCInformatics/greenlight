    ...
    def createFormTemplates(){
		...
		if (ConsentFormTemplate.count() == 9) {
			...
			new ConsentFormTemplate(
					...
					/* 12 */).addToQuestions(new Question(optional: true, labelIfNotYes: "Do not contact", name: 'I agree to be contacted about ethically approved research studies for which my child may be suitable. I understand that agreeing to be contacted does not oblige my child to participate in any further studies.', validResponses: [Response.ResponseValue.YES, Response.ResponseValue.NO, Response.ResponseValue.BLANK, Response.ResponseValue.AMBIGUOUS], defaultResponse: Response.ResponseValue.BLANK)
			).save(failOnError: true)
		...
		if(ConsentFormTemplate.count()== 15)
		{

			new ConsentFormTemplate(
					name: "100,000 Genomes Project (Main) – Parents of Children With Cancer(or suspected cancer) Consent Form",
					namePrefix: "GLM",
					templateVersion: "Version 1.2 dated 01.01.2017",
					cdrUniqueId : "GEL_MAN_CHD_V1_2"
					/* 1 */ ).addToQuestions(new Question(name: '''I have legal parental responsibility for the child named below. I agree to the following:
																	- You can tell my child’s GP and other healthcare professionals that my child has joined the project
																	- You can use my child’s samples and data in the project at any  me, including a er their death (if this were to happen), unless I withdraw them from the project.
																	- You at Genomics England and the clinical team can contact me to:
																		* ask my child to donate more information for the project;
																		* ask my child to donate further samples if needed in the future;
																		* invite my child to join other research; and
																		* send me general updates about the project.
																	''',
					validResponses: [Response.ResponseValue.YES,Response.ResponseValue.NO,Response.ResponseValue.BLANK,Response.ResponseValue.AMBIGUOUS],
					defaultResponse: Response.ResponseValue.BLANK)
					/* 2 */ ).addToQuestions(new Question(name: ''' I agree that my child can donate to the project: 
																	 - a sample of blood;
																	 - other samples, such as saliva, if needed; and
																	 - samples already collected as part of their medical care. This includes samples of my child’s tumour or bone marrow, depending on their type of cancer.
																	My child’s samples can be used for:
																	 - collecting DNA for whole genome sequencing; and
																	 - studying their blood to find out how the DNA is working.
																 	I understand that there might be new ways of doing this in the future.
																	Samples or DNA could be sent to approved organisations outside the UK for processing or analysis.''',
					validResponses: [Response.ResponseValue.YES,Response.ResponseValue.NO,Response.ResponseValue.BLANK,Response.ResponseValue.AMBIGUOUS],
					defaultResponse: Response.ResponseValue.BLANK)
					/* 3 */ ).addToQuestions(new Question(name: 'I agree that the project can access and collect electronic copies of my child’s past and future health records...',
					validResponses: [Response.ResponseValue.YES,Response.ResponseValue.NO,Response.ResponseValue.BLANK,Response.ResponseValue.AMBIGUOUS],
					defaultResponse: Response.ResponseValue.BLANK)
					/* 4 */ ).addToQuestions(new Question(name: ''' I agree that:
										- tests can be run on my child’s samples and health information on to look for the cause of my child’s cancer and to  nd ways to manage their cancer; and
										- the results can be reported to my child’s clinical team for them to discuss with me.
										
										I understand the following.
										- Information generated by this project may benefit my family members, now or in the future. If relevant, the NHS will support me in sharing this with them.
										- My child may not get information that will help with their medical care, now or in the future.
										- Results may not be returned in  me to be used in my child’s medical care. 
										I understand that apart from my child’s cancer and additional findings (if I have asked for them)
										no other information will be looked for or reported.''',
					validResponses: [Response.ResponseValue.YES,Response.ResponseValue.NO,Response.ResponseValue.BLANK,Response.ResponseValue.AMBIGUOUS],
					defaultResponse: Response.ResponseValue.BLANK)
					/* 5 */).addToQuestions(new Question(optional: true,
					labelIfNotYes: "I do not want additional findings to be looked for and given to my child’s clinical team.",
					name: '''Additional findings (optional): I understand the following.
										- I can choose if I want certain other conditions that might affect my child to be looked for in their samples ('additional findings').
										- These conditions are not connected to my child's cancer.
										- All the conditions can potentially be treated or prevented.
										- Results might also be important to other members of my family.
										- Even if the results seem to show that my child does not have one of the conditions, they may s ll get it in the future.
										- We may add to or change which conditions we look for. This means my child might get other results in the future.
										- I can change my mind at any time about receiving additional findings for my child.
										''',
					validResponses: [Response.ResponseValue.YES,Response.ResponseValue.NO],defaultResponse: Response.ResponseValue.NO)
					).save(failOnError: true)
