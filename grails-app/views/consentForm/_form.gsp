<%@ page import="uk.ac.ox.brc.greenlight.ConsentForm; uk.ac.ox.brc.greenlight.ConsentForm" %>
    ...
    <div class="panel panel-primary PageMainPanel">
        <div class="panel-body">
            ...
            <div class="col-md-6 ">
                ...
                <div class="form-group">
                    <label for="consentForm.clinicianName" class="required">Clinician Name</label>
