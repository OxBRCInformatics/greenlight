...
class DatabaseCleanupServiceSpec extends IntegrationSpec {
	...
	def AddConsentWithoutAccessGUID(){
		...
		sql.executeUpdate(
				'insert into CONSENT_FORM (accessGUID,version,formid,form_status,template_id,PASSED_TOCDR) values(?, ?, ?, ?, ?,?)',
				["1f91bb5c10d922ce6923b657324a6a4f",0, 'GEL12356',"NORMAL",template.id,false])
		sql.executeUpdate(
				'insert into CONSENT_FORM (accessGUID,version,formid,form_status,template_id,PASSED_TOCDR) values(?, ?, ?, ?, ?,?)',
				["1f91bb5c10d91125524a6a4f",0, 'GEL12356',"NORMAL",template.id,false])
